...
from functional.psycopg.helpers import *


class TestRoutePsycopg2(unittest.TestCase):

    def setUp(self) -> None:
        self.flask_app = create_app(test_config=True)

    # @unittest.skip('Tested')
    def test_creating_note_psycopg2(self):
    ...
    # @unittest.skip('')            
    def test_reading_note_psycopg2(self):
        with self.flask_app.test_client() as test_client:
    ...
    # @unittest.skip('')
    def test_updating_note_psycopg2(self):
        with self.flask_app.test_client() as test_client:
    ...
    def test_update_with_wrong_id_psycopg2(self):
        with self.flask_app.test_client() as test_client:

            response = updating_note_with_empty_id(test_client)
    ...
    def test_deleting_note_psycopg2(self):
        with self.flask_app.test_client() as test_client:
    ...
    def test_deleting_with_wrong_id_psycopg2(self):
        with self.flask_app.test_client() as test_client:
